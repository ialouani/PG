...
static void test_set__remove_with_shift (void) {
  ...
  int a=3;int b=4;int c=1; int d=2;
  set__remove(&st, (void*)&a);
  assert(st.s[0] == 1);
  assert(st.s[1] == 2);
  assert(st.s[2] == 4);
  assert(st.s[3] == SET__BOUND);
  
  set__remove(&st, (void*)&b);
  assert(st.s[0] == 1);
  assert(st.s[1] == 2);
  assert(st.s[2] == SET__BOUND);
  set__remove(&st, (void*)&c);
  assert(st.s[0] == 2);
  assert(st.s[1] == SET__BOUND);

  set__remove(&st, (void*)&d);
...
static void test_set__find(){
  ...
  int a1=3;int a2=4;int a3=1;int a4=10;int a5=8;
  int a6=3;int a7=0;int a8=20;int a9=10;int a10=4;int a11=-1;
  assert(set__find(&t1,(void*)&a1)==1);
  assert(set__find(&t1,(void*)&a2)==1);
  assert(set__find(&t1,(void*)&a3)==0);
  assert(set__find(&t2,(void*)&a4)==1);
  assert(set__find(&t2,(void*)&a5)==0);
  assert(set__find(&t2,(void*)&a6)==0);
  assert(set__find(&t1,(void*)&a7)==1);
  assert(set__find(&t3,(void*)&a8)==0);
  assert(set__find(&t3,(void*)&a9)==0);
  assert(set__find(&t4,(void*)&a10)==0);
  assert(set__find(&t4,(void*)&a11)==0);
...
static void test_set__add(){
  ...
  int a=11;int b=5;
  assert(set__add(&set22,(void*)&b)==0);
  assert(set__add(&set11,(void*)&a)==0);
  assert(find(set11.s,11)==0);
  assert(find(set22.s,5)==1);
  assert(set__find(&set11,(void*)&a)==1);
  assert(set__find(&set22,(void*)&b)==1);
  int c=3;
  set__add(&se1,(void*)&c);
  assert(se1.s[0]==1);
  assert(se1.s[1]==2);
  ...
  set__add(&se1,(void*)&c);
  assert(set__add(&se1,(void*)&c)==-1);//adding element twice return error code integer.
  struct set se2={{1,20,40,50,SET__BOUND,4,56,12222}};
  int d=4;int e=45;int f=42;int g=30;
  set__add(&se2,(void*)&d);
  set__add(&se2,(void*)&e);
  set__add(&se2,(void*)&f);
  set__add(&se2,(void*)&g);
...
static void test_set__remove(){
  int a1=1;int a2=2;int a3=4;int a4=5;
  struct set se1={{1,2,4,5,SET__BOUND}};
  set__remove(&se1,(void*)&a4);
  assert(se1.s[0]==1);
  assert(se1.s[1]==2);
  assert(se1.s[2]==4);
  ...
  assert(se1.s[4]==0);
  struct set se2={{1,20,40,50,SET__BOUND,4,56,12222}};
  set__remove(&se2,(void*)&a1);
  int b0=40;
  set__remove(&se2,(void*)&b0);
  assert(se2.s[0]==20);
  assert(se2.s[1]==50);
  ...
  int c1=10;int c2=20;
  assert(set__remove(&set111,(void*)&c1)==-1);
  assert(set__remove(&set111,(void*)&c2)!=0);
  set__add(&set111,(void*)&c1);int c3=13;
  set__add(&set111,(void*)&c3);//pour qu'elle soit non vide => 2 tests a prevoir.
  int dernier_1=-1;int dernier_2=-2;
  assert(set__remove(&set111,(void*)&dernier_1)==-1);
  assert(set__remove(&set111,(void*)&dernier_2)==-1);//test de remove sur une liste non vide
